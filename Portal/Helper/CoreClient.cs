...
namespace Demo.Portal.Helper
{
    ...
    public class CoreClient : ICoreClient
    {
        ...
        {
            message = "";
            String respContent = QueryStr(accessToken, uri, parameter, out message, method);
            if (respContent == null)
            {
                return null;
            }
        ...
        {
            message = "";
            String respContent = QueryData(uri, parameter, loginInfo, stringLoginInfo, out message);
            if (respContent == null)
            {
                return null;
            }
        ...
        {
            message = "";
            String respContent = QueryStrBase64(uri, parameter, stringLoginInfo, out message);
            if (respContent == null)
            {
                return null;
            }
        ...
        {
            message = "";
            String respContent = QueryStrNoToken(uri, parameter, out message);
            if (respContent == null)
            {
                return null;
            }
        ...
        public String QueryStr(string accessToken, string uri, object parameter, out string message, Method method)
        {
            ...
            RestClient client = new RestClient(_setting?.UrlPrefix);
            ...
            out string message)
        {
            ...
            string userPass = stringLoginInfo;
            var plainTextBytes = System.Text.Encoding.UTF8.GetBytes(userPass);
            string base64UserPass = Convert.ToBase64String(plainTextBytes);
