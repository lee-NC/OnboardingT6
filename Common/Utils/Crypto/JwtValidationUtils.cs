...
namespace Demo.Common.Utils.Crypto
{
    public class JwtValidationUtils
    {
        ...
        {
            string key = conf["Identityserver:Key"];
            ...
            var validateAud = ("" + conf["Identityserver:ValidateAudience"]).Equals("true", StringComparison.OrdinalIgnoreCase);
            var validateIss = ("" + conf["Identityserver:ValidateIssuer"]).Equals("true", StringComparison.OrdinalIgnoreCase);
